...
out_dir = r"Z:\DATA_ANALYSIS\NEFSC_GOM\Detector_output\Dolphins\Database and Binaries\To Validate"
in_dir = r"Z:\DATA_ANALYSIS\NEFSC_GOM\Detector_output\Dolphins\Database and Binaries\To Validate"

file_name = "NEFSC_GOM_202007_SEALISLAND_Dolphins"
data_folder = r"Z:\ACOUSTIC_DATA\BOTTOM_MOUNTED\NEFSC_GOM\NEFSC_GOM_202007_SEALISLAND\5423_48kHz_UTC"
deployment_file = r"Z:\DATA_ANALYSIS\NEFSC_GOM\Detector_output\Dolphins\deployment_info.csv"


audio_files_ext = ".wav"
sql_table_name = "Whistle_and_Moan_Detector"
class_name = "WMD"
time_offset = 0
...
for idx, detec in sql_table.iterrows():
    ...
    fs = detec["startSample"] / detec["startSeconds"]
...
annot.insert_values(operator_name="AID")
annot.insert_values(UTC_offset=0)
annot.insert_values(confidence=1)
annot.insert_values(software_name="PAMGuard-WMD")
